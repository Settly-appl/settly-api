...
class ExpensesControllerTest {
    ...
    void should_return_200_when_getting_expense() throws Exception {
        given(expenseService.getExpense(UUID.fromString(EXPENSE_ID), UUID.fromString(USER_ID))).willReturn(responseExpense);
    ...
    void should_return_401_when_getting_expense_without_auth() throws Exception {
        mockMvc
                .perform(get("/expenses/{expenseId}", EXPENSE_ID))
                .andExpect(status().isUnauthorized());
    }
